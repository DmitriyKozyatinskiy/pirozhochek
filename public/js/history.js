...
var _enquire = __webpack_require__(365);
...
function convertData(data) {
  var dataArray = Object.keys(data.visits).map(function (key) {
    return {
      groupName: key,
  ...
  dataArray.forEach(function (item) {
    item.visits.map(function (visit) {
...
function concatLoadedHistory(data) {
  data.forEach(function (group) {
    var loadedGroup = loadedHistory.find(function (loadedGroup) {
      return loadedGroup.groupName === group.groupName;
    });
    if (loadedGroup) {
...
function removeItemsFromLoadedHistory(ids) {
  loadedHistory.forEach(function (loadedGroup) {
    _.remove(loadedGroup.visits, function (visit) {
...
function selectGroup(event) {
  ...
  var $checkboxes = $groupCheckbox.closest('.js-history-group').find('.js-history-remove-checkbox');
...
function selectHistoryCheckbox(event) {
  ...
  var $group = $checkbox.closest('.js-history-group');
  var $checkboxes = $group.find('.js-history-remove-checkbox');
...
$(function () {
  ...
  $(document).on('submit', '#js-history-form', handleSearch).on('reset', '#js-history-form', handleReset).on('click', '.js-history-group-checkbox', selectGroup).on('change', '.js-history-remove-checkbox', selectHistoryCheckbox).on('click', '#js-history-remove-all-button', function () {
    $('#js-history-confirmation-modal').modal('show');
  }).on('click', '#js-history-all-remove-proceed', function () {
    ...
    event.preventDefault();
    var ids = [];
    var $checkedRows = $('.js-history-remove-checkbox:checked');
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\Projects\\M4DH\\resources\\assets\\js\\helpers.js'");
...
var QueryHandler = __webpack_require__(364);
...
var MediaQuery = __webpack_require__(362);
...
var MediaQueryDispatch = __webpack_require__(363);
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\Projects\\M4DH\\resources\\assets\\js\\History\\History.html'");
